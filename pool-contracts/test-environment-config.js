...
module.exports = {
  ...
  contracts: {
    ...
    defaultGasPrice: 31e9, // Gas price for contract calls (when unspecified)
  ...
  node: { // Options passed directly to Ganache client
    ...
    gasPrice: 31e9 // Sets the default gas price for transactions if not otherwise specified.
  },
};
