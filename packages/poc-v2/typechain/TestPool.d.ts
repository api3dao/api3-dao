...
interface TestPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "totalStakedNow()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "totalStakedNow",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class TestPool extends Contract {
  ...
  functions: {
    ...
    totalStakedNow(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    totalStakedNow(overrides?: CallOverrides): Promise<PopulatedTransaction>;
