...
describe('contracts', function () {
    ...
    before(function () { return __awaiter(void 0, void 0, void 0, function () {
        var api3Token, api3Pool, signer0;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    api3Token = _a.sent();
                    return [4 /*yield*/, api3Token.deploy(accounts[0], accounts[0])];
                case 3:
                    token = (_a.sent());
                    return [4 /*yield*/, hre.ethers.getContractFactory("Api3Pool")];
                case 4:
                    api3Pool = _a.sent();
                    return [4 /*yield*/, api3Pool.deploy(token.address)];
                case 5:
                    pool = (_a.sent());
    ...
    it('deposits and stakes tokens', function () { return __awaiter(void 0, void 0, void 0, function () {
        var signer, account, allowance, staker, stakerBalance, stakerBalance2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, staker.updateAndGetBalanceOf(accounts[1])];
                case 7:
                    stakerBalance2 = _a.sent();
