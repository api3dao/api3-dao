...
interface TestPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "updateCurrentAprTest()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateCurrentAprTest",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class TestPool extends Contract {
  ...
  functions: {
    ...
    updateCurrentAprTest(overrides?: Overrides): Promise<ContractTransaction>;

    "updateCurrentAprTest()"(
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setApr(_currentApr: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    updateCurrentAprTest(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    updateCurrentAprTest(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    updateCurrentAprTest(overrides?: Overrides): Promise<PopulatedTransaction>;
